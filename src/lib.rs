...
impl SecretKey {
    ...
    ///
    /// *WARNING* this constructor will overwrite the referenced `Scalar` element with zeros after it
...
impl SecretKeyShare {
    ...
    ///
    /// *WARNING* this constructor will overwrite the pointed to `Scalar` element with zeros once it
